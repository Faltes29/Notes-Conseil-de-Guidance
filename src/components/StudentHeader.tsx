      ...
      <CardContent className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-3">
          ...
          <Select defaultValue="période 1">
            <SelectTrigger id="period-select" className="rounded-xl border-slate-200 bg-white focus:ring-violet-500">
        ...
        <div className="space-y-3">
          ...
          <RadioGroup value={currentStudent?.gender} className="flex gap-3 pt-1">
            <div className="flex items-center space-x-2 bg-slate-50 px-3 py-2 rounded-xl border border-slate-100 cursor-pointer hover:bg-violet-50 transition-colors flex-1">
              <RadioGroupItem value="f" id="sex-f" className="text-violet-600 border-slate-300" />
              <Label htmlFor="sex-f" className="cursor-pointer text-slate-700 font-medium text-sm">Fille</Label>
            </div>
            <div className="flex items-center space-x-2 bg-slate-50 px-3 py-2 rounded-xl border border-slate-100 cursor-pointer hover:bg-violet-50 transition-colors flex-1">
              <RadioGroupItem value="m" id="sex-m" className="text-violet-600 border-slate-300" />
